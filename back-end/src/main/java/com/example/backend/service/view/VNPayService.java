...
import com.example.backend.config.VnpayConflig;
...
public class VNPayService {
    public ResponseEntity<VNPayDto> createPayment(GetAllProductSaleDto.ProductDetailDto.SizeDto getAllProductSaleDto){
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(getAllProductSaleDto.getAvailAmount() * 100));
        vnp_Params.put("vnp_CurrCode", "VND");

        vnp_Params.put("vnp_TxnRef", vnp_TxnRef);
        vnp_Params.put("vnp_OrderInfo", String.valueOf(getAllProductSaleDto.getId()));
        vnp_Params.put("vnp_OrderType", orderType);

        String locate = "vn";
        vnp_Params.put("vnp_Locale", locate);

        vnp_Params.put("vnp_ReturnUrl", VnpayConflig.get_Return_url(getAllProductSaleDto.getAvailAmount(), String.valueOf(getAllProductSaleDto.getId())));
    ...
    public ResponseEntity<VNPayDto> createPaymentMuaNgay(GetAllProductSaleDto getAllProductSaleDto){
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VnpayConflig.getRandomNumber(8);
        String vnp_IpAddr = "127.0.0.1";
