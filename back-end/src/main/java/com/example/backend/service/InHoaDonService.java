...
//        List<OrderDetail> hoaDonChiTiets = orderDetailRepository.findByIDBill(hoaDonId);
//        Optional<Orders> optHoaDon = ordersRepository.findById(hoaDonId);
//        if (optHoaDon.isPresent()) {
//            Orders hoaDon = optHoaDon.get();
...
//            htmlContentBuilder.append("<h1>").append("FIVE-START").append("</h1>");
//
//            NumberFormat numberFormat = NumberFormat.getCurrencyInstance(new Locale("vi", "VN"));
//            // Thêm thông tin đơn hàng
//            Date ngayTao = hoaDon.getCreatedAt();
//            String formattedTienGiam;
//            Voucher km = (Voucher) hoaDon.getListVoucher();
//
//            // Kiểm tra nếu khuyến mãi là null hoặc không có id
//            if (km == null || km.getId() == null) {
//                formattedTienGiam = "0 VNĐ";
//            } else {
//                BigDecimal tienGiamToiDa = BigDecimal.valueOf(km.getMoney());
//
//                BigDecimal tienGiamHoaDon = BigDecimal.valueOf(hoaDon.getVoucher());
//
...
//            htmlContentBuilder.append("<p>Mã đơn hàng: ").append(hoaDon.getId()).append("</p>");
//            htmlContentBuilder.append("<p>Ngày mua: ").append(formattedNgayTao).append("</p>");
//            htmlContentBuilder.append("<p>Khách hàng: ").append(hoaDon.getName()).append("</p>");
//            htmlContentBuilder.append("<p>Số điện thoại khách hàng: ").append(hoaDon.getPhone()).append("</p>");
//            htmlContentBuilder.append("<p>Trạng thái đơn: Đã thanh toán</p>");
////            htmlContentBuilder.append("<p>Nhân viên bán hàng: ").append(hoaDon.getListOrderDetail().ge).append("</p>");
//
//
//            String formattedTongTienDonHang = numberFormat.format(hoaDon.getTotalPrice());
//            String formattedTongTienHoaDon = numberFormat.format(hoaDon.getTotalPayment());
...
//            for (OrderDetail hoaDonChiTiet : hoaDonChiTiets) {
//                NumberFormat fomatTien = NumberFormat.getCurrencyInstance(new Locale("vi", "VN"));
//                String fomatTienSanPham = fomatTien.format(hoaDonChiTiet.getOrders().getTotalPayment());
//                htmlContentBuilder.append("<tr>");
//                htmlContentBuilder.append("<td>").append(hoaDonChiTiet.getOrders().getName())
////                        .append(" (").append(hoaDonChiTiet.getStatsProducts().g)
////                        .append("/").append(hoaDonChiTiet.getSanPhamChiTiet().getMauSac().getTenMauSac()).append(")")
////                        .append("</td>");
//
//                htmlContentBuilder.append("<td>").append(hoaDonChiTiet.getQuantity()).append("</td>");
